私がこれから送信する文章について、構成を見直してリライトして下さい。私はあなたの要求に基づき、いくつかに分割して送信し、最後に"本文完了"を送ります。あなたは、以下の出力例に基づき、ソースコードブロックで囲んだ日本語テキストとして出力して下さい。テキストの中のソースコードがソースコードブロックで囲われていないことに注意して下さい。
